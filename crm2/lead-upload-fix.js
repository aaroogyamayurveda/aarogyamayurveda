/* CRM2 Lead Upload reliability patch v4 */
(function(){
  function client(){
  ...
  function installGuard(){
    if(document.documentElement.dataset.crm2ImportGuard==='1')return;
    document.documentElement.dataset.crm2ImportGuard='1';
    document.addEventListener('click',function(e){
      const b=e.target.closest && e.target.closest('#crm2ImportBtn');
      if(!b)return;
      e.preventDefault();
